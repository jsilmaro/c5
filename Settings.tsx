...
const handleAvatarRemove = async (user: { name?: string | null }) => {
  try {
    await authApi.updateProfile({ name: user?.name || "", avatar: null });
...
const Settings = () => {
  ...
  try {
    ...
    // ✅ Ensure the UI updates with the new avatar
    if (response.data.avatar_url) {
      setCurrentUser((prevUser) => ({
        ...prevUser,
        avatar: response.data.avatar_url, // ✅ Update avatar immediately
      }));
    }
